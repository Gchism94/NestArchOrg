...
FidelityZones <- function(data_table){
  ...
  # Final data set
  FidelityZonesDataRD1_RD2 <<- left_join(data_table, FidelityZonesDataRaw, relationship = "many-to-many") %>%
    distinct() %>%
    drop_na()
}
...
# Write the data
write.csv(WorkerDistScaledRD1_RD2SFZWorking, here("analysis", "data", "processed", "WorkerDistScaledRD1_RD2SFZWorking.csv"), row.names = FALSE)
...
# Write the data
write.csv(BroodCentDistWorkersSFZFull, here("analysis", "data", "processed", "BroodCentDistWorkersSFZFull.csv"), row.names = FALSE)

# Write the data
write.csv(BroodCentDistWorkersSFZ, here("analysis", "data", "processed", "BroodCentDistWorkersSFZ.csv"), row.names = FALSE)