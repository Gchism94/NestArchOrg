...
FullDensityPlot <- ggarrange(WorkerDensityColony, BroodDensityColony,
                             AlateQueenDensity, 
...
SFZDist.Box1 <- SFZDist1 + annotation_custom(grob = SFZ_grob.1, xmin = 0.85, xmax = 1.2,
                                                       ymin = fidymin, ymax = fidymax
)

SFZDist.Box2 <- SFZDist2 + annotation_custom(grob = SFZ_grob.2, xmin = 0.85, xmax = 1.2,
                                                       ymin = fidymin, ymax = fidymax
)
...
OccurDist1 <- ggplot(data = WorkerDistScaledRD1_RD2SFZWorking %>% filter(Density == "High") %>% arrange(Nest),
  ...
  scale_color_manual(breaks = c("Circle", "Tube"), 
                     ...
                     values = c("blue", "red"),
                     labels = c("Circle", "Tube")) +
  scale_x_continuous(labels = scaleFUNDist, limits = c(0, 1.2)) +  
...
OccurDist.Box1 <- OccurDist1 + annotation_custom(grob = Occur_grob.1, xmin = 0.9, xmax = 1.2,
                                                           ymin = occurymin, ymax = occurymax
)

OccurDist.Box2 <- OccurDist2 + annotation_custom(grob = Occur_grob.1, xmin = 0.9, xmax = 1.2,
                                                           ymin = occurymin, ymax = occurymax
)
